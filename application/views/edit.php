...
<body>
  ...
  <div>
     <form class="form-style-4" action="<?= base_url('index.php/users/update') ?>" method ="post" >
  ...
  <div class="form-style-4">
                        <label for="field1">
                            <span align="left">PAN No.</span>: <input type="text" name="pan" class="pan"  MaxLength="10" onblur="ValidatePAN(this);" value="<?= $r->pan ?>" placeholder="XXXXX0000X"/> 
                        </label>
                        <label for="field1">
                            <span align="left">Service Tax No.</span>: <input type="text" name="sertaxnum" value="<?= $r->sertaxnum ?>" /> 
                        </label>
                        <label for="field1">
                            <span align="left">Excise No.</span>:<input type="text" name="exnum"  maxlength="15" class='exnum' onblur="ValidateEX(this);" placeholder="XXXXX0000XXX000"   value="<?= $r->exnum ?>" /> 
                        </label>
                        <label for="field1">
                            <span align="left">TIN No.</span>:<input type="text" name="tin" class=""  maxlength="11" placeholder='Enter 11 Digits TIN No.' onkeypress="return isNumberKey(event)"  value="<?= $r->tin ?>" /> 
                        </label>
                        <label for="field1">
                            <span align="left">CIN No.</span>:<input type="text" name="cin_no" maxlength='21' placeholder="Enter 21 AlphaNumeric CIN No."  value="<?= $r->cin ?>" /> 
                        </label>
                        <label for="field1">
