  ...
  <div>
     <form class="form-style-4" action="<?= base_url('index.php/users/insert_user_db') ?>" method ="post" >
                        ...
                        <label for="field1"><input type="hidden" name="id" value="<?= $r->cust_supp_id ?>" />
                            <span align="left" class='control-label'>Customer Name</span>: <?= $r->name ?>
                        </label>
                        <label for="field1">
  ...
  <div class="form-style-4">
    ...
    <div>         
        ...
        <tr>
            ...
            <td><?= $row->mob; ?></td>
            <td><?= $row->supp_mail; ?></td>
            <td><a href="<?= base_url('index.php/users/delete_cnt_cust/'.$row->id); ?>" class="btn btn-danger glyphicon glyphicon-remove"></a></td>
        </tr>
        <?php } ?>
        </table>
                </div>
            ...
            <div class="fixed-action-btn vertical" style="bottom: 45px; right: 24px;">
                ...
                <ul>
                    <li><a class="btn-floating orange darken-1" data-placement="bottom" title="View Customer List" href="<?php echo base_url();?>index.php/users/cust_detail"><i class="glyphicon glyphicon-eye-open"></i></a></li>
