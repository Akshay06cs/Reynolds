   ...
   <body>
        ...
        <div class="container form-group required">
            ...
            <div class="jumbotron">
                ...
                <center><h2>Reynolds Chemequip Pvt. Ltd.</h2><br><h4>Edit Part Detail</h4></center>
                        <div class='form-style-4'>
                            <input type="hidden" name="pid" value="<?= $r->pid; ?>">
                        <label for="field1" class="part_cat">
                            <span align="left" class='control-label'>Part Category</span>: <input type="text" name="category" required="true" id="category" value="<?= $r->category ?>"/>
                        </label>
                        ...
                        <label for="field1" class="part_sub">
                            <span align="left">Sub Moc</span>: <input type="text" name="sub_moc" id="sub_moc"  value="<?= $r->sub_moc ?>" onkeyup="description()" />
                        </label>
                        ...
                        <label for="field1" class="part_type">
                            <span align="left">Type</span>: <input type="text" name="type"  id="type"  value="<?= $r->type ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_thickness">
                            <span align="left">Thickness </span>: <input type="text" name="thickness"  id="thickness" style="width:175px;" placeholder="Enter Thickness"  value="<?= $r->thickness ?>" onkeyup="description()"/>
                            <select class="person" name="thickness_uom" id='thickness_uom' style="font-family: Georgia;width:175px;" onchange="description()">
                            <option><?= $r->thickness_uom ?></option>
                            <option>mm</option>
                            <option>"</option>
                            </select>
                        ...
                        <label for="field1" class="part_size">
                            <span align="left">Size </span>: <input type="text" name="size" id="sizee" style="width:175px;" placeholder="Enter Size"  value="<?= $r->size ?>" onkeyup="description()"/>
                            <select class="person" name="size_uom" id="size_uom" style="font-family: Georgia;width:175px;" onchange="description()">
                            <option><?= $r->size_uom ?></option>    
                            <option>mm</option>
                            <option>"</option>
                            </select>
                        </label>
                        <label for="field1" class="part_length">
                            <span align="left">Length </span>: <input type="text" name="length"  id="length" style="width:175px;" placeholder="Enter Length"  value="<?= $r->length ?>" onkeyup="description()" />
                            <select class="person" name="length_uom" id='length_moc' style="font-family: Georgia;width:175px;" onchange="description()">
                                <option><?= $r->length_uom ?></option>
                                <option>mm</option>
                                <option>"</option>
                            </select>
                        </label>
                        <label for="field1" class="part_pass">
                            <span align="left" >Pass</span>: <input type="text" name="pass"  id="pass"  value="<?= $r->pass ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_holes">
                            <span align="left" >Holes</span>: <input type="text" name="holes" id="holes"   value="<?= $r->holes ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_cuts">
                            <span align="left" >Cuts</span>: <input type="text" name="cuts" id="cuts"  value="<?= $r->cuts ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_density">
                            <span align="left" class='control-label'>Density</span>: <input type="text" name="density" id="density" required="required"  value="<?= $r->density ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_ot_dia">
                            <span align="left" class='control-label'>Outer Diameter </span>: <input type="text" name="outer_diameter" id="outer_diameter" style="width:175px;"  value="<?= $r->outer_diameter ?>" onkeyup="description()"/>
                            <select class="person" name="od_uom" id='outer_diameter_uom' style="font-family: Georgia;width:175px;" onchange="description()">
                                <option><?= $r->od_uom ?></option>
                                <option>mm</option>
                                <option>"</option>
                            </select>
                        </label>
                        <label for="field1" class="part_bwg">
                            <span align="left">BWG </span>: <input type="text" name="bwg" id="bwg" style="width:175px;" placeholder="Enter BWG"  value="<?= $r->bwg ?>" onkeyup="description()"/>
                            <select class="person" name="bwg_uom" id="bwg_uom" style="font-family: Georgia;width:175px;" onchange="description()">
                                <option><?= $r->bwg_uom ?></option>
                                <option>BWG</option>
                            </select>
                        </label>
                        <label for="field1" class="part_sch">
                            <span align="left">Schedule</span>: <input type="text" name="schedule" id="schedule" placeholder="Enter Schedule"  value="<?= $r->schedule ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_radius">
                            <span align="left" >Radius</span>: <input type="text" name="radius" id="radius" placeholder="Enter Radius"  value="<?= $r->radius ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_degree">
                            <span align="left">Degree</span>: <input type="text" name="degree" id="degree" placeholder="Enter Degree"  value="<?= $r->degree ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_pattern">
                            <span align="left">Pattern No.</span>: <input type="text" name="pattern_no" id="pattern_no" placeholder="Enter Pattern No."  value="<?= $r->pattern_no ?>" onkeyup="description()"/>
                        </label>
                        <label for="field1" class="part_rating">
                            <span align="left" >Rating</span>: <input type="text" name="rating" id="rating" placeholder="Enter Rating"  value="<?= $r->rating ?>" onkeyup="description()"/>
                        </label> 
                        <label for="field1" class="part_threading">
                            <span align="left">Threading </span>: <input type="text" name="threading" id="threading" style="width:175px;" placeholder="Enter Threading"  value="<?= $r->threading ?>" onkeyup="description()"/>
                            <select class="person" name="threading_uom" id='threading_uom' style="font-family: Georgia;width:175px;" onchange="description()">
                                <option><?= $r->threading_uom ?></option>
                                <option>mm</option>
                        ...
                        <label for="field2" >
                            <span align="left" class='control-label'>UOM</span>: <select class="person" id="uom" name="uom" style="font-family: Georgia;" onchange="description()">
                                <option><?= $r->uom ?></option>
                                <option>Kgs.</option>
                                <option>Mtr.</option>
                                <option>Nos.</option>  
