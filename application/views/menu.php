    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <!-- ADMIN PANNEL -->
            ...
            <!-- Main Header -->
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="label label-warning" id="count"></span>   <input type="hidden" class="gp_count" value="<?= $count_gp ?>"><input type="hidden" value="<?= $count_po ?>" class="po_count"><input type="hidden" value="<?= $count_adv ?>" class="adv_count">
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li>
                    ...
                    <li>
                      ...
                      <li>
                          <ul class="menu">
                                <?php
                                    foreach($advpend->result() as $row){
                                ?>
                                <li>
                                    <a href="<?= base_url('index.php/users/payment_approval/'.$row->loan_id);?>">Loan Sanction:<small style="color:grey"><?= $row->l_emp_name?></small></a>
                                </li>
                              <?php
                                    }
                              ?>
        ...
        ?>
            ...
            <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url();?>index.php/users/pro_detail"><i class="fa fa-circle-o"></i>RCPL Products</a></li>
                         <li><a href="<?php echo base_url();?>index.php/users/onlineUsers"><i class="fa fa-circle-o"></i>Online Users</a></li>
                    </ul>
                </li>    
        ...
        ?>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>index.php/users/pur_invoice">Purchase Invoice</a></li>
                <?php } ?>
                ...
                {
                ?>
                <li><a href="<?php echo base_url();?>index.php/users/show_loan">Loan</a></li>
                <li><a href="<?php echo base_url();?>index.php/users/show_adv_pmt">Advance Payment</a></li>
                <?php
                }
                else{
                ?>
                    <li><a href="<?php echo base_url();?>index.php/users/new_loan">Loan</a></li>
                    <li><a href="<?php echo base_url();?>index.php/Users/new_advance_payment">Advance Payment</a></li>
                <?php }
                ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>index.php/users/view_stock">Stock</a></li>
                <li><a href="<?php echo base_url();?>index.php/users/employee_daily_attendence">Attendence</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            </h1><?php date_default_timezone_set('Asia/Calcutta'); echo date("h:i a"); ?>
        ...
        <section class="content">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
<div class="alert alert-success" title="Online Users">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <?php 
    foreach($onlineUser as $u_key){ ?>
    <?php echo $u_key->f_name; ?> <?php echo $u_key->l_name; ?> Logged In Since <?php echo  date("g:i a", strtotime($u_key->time)); ?><br>
    <?php 
    } ?> 
</div>
                        </div>
        ...
        <div class="tab-content"  style="overflow-y: scroll; height:400px;">
          ...
          <table>
            ...
            <tr class="row-item">
                    ...
                    <td><?= $row->user_data ?> (<small style='color:grey;'><?= $row->time_stmp ?><?= $row->am_pm ?> <?= date('d-m-Y', strtotime(str_replace('-','/', $row->sess_date))); ?><small>) </td>
  ...
  <script>
       ...
       $(document).ready(function(){
          ...
          var total= parseInt(gp_count) + parseInt(po_count);
            ...
            if(level=='1')
            {
                var total=parseInt(adv_count) + parseInt(gp_count) + parseInt(po_count);
                $('#count').html(total);
            }
            else if(level=='6')
            {
                $('#count').html(adv_count);
            }
        });
  </script>
             ...
             <?php echo validation_errors(); ?>
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input class="form-control" id="cpassword" type="password" name="cpassword" onBlur = "validate()">
