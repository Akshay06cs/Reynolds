<html>
                    ...
                    <div class="modal-content">
                        <form name="deposit" action="<?php echo base_url(); ?>index.php/users/deposit_amt" method ="post">
                            <div class="modal-body">
                                ...
                                <input type="text" name="empname" id="empname"  required="required" class="form-control" placeholder="Employee Name" value="<?php echo $row['ld_emp_name']; ?>" readonly><input type="hidden" name="empid" id="empid" class="empid" value="<?php echo $row['id'];?>"/><input type="hidden" name="job_category" id="job_category" value="<?php echo $row['ld_job_category']; ?>"/>
    ...
    <script>
        ...
        function num_only()
        {
            $('.amtdeposit').keypress(function(e){
