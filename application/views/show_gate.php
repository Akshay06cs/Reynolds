<html>
    ...
    <tr>    
            <td> <?= $row->gate_pass_id ?></td>
            <td> <?= $row->date ?></td>
            <td> <?= $row->name ?></td>
            <td> <?= $row->purpose ?></td>
            <td> <?= $row->ttime ?></td>
            <td> <?= $row->mob ?></td>
            <td><a href="<?= base_url('index.php/users/delete_gate_pass/'.$row->gate_pass_id); ?>" class="btn btn-danger btn-sm glyphicon glyphicon-minus"></a></td>
            <td><a href="<?= base_url('index.php/users/gate_pass_approval/'.$row->gate_pass_id); ?>" class="btn btn-info btn-sm glyphicon glyphicon-list"></a></td>
    </tr>
            <?php } ?>
    </tbody>
</table>
