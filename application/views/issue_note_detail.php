            ...
            <input type="hidden" id="order_no" name="order_no" value="">
                <hr>
                    ...
                    <div style="width: 100%;">
                        ...
                        <div style="float:right;width: 40%">
                            <table class='payment'>
                                <tr><th>Issue No.</th><td><?= $r->issue_no ?></td></tr>
                                <tr><th>Date</th><td><?= $r->issue_date ?></td></tr>
                                <tr><th>Work Order</th><td><?= $r->work_order ?></td></tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <?php
                            $data  = $this->db->query("SELECT * FROM issue_detail WHERE issue_no='{$r->issue_no}'");
                            foreach($data->result() as $row){ ?>
                    <tr class="item-row">
                        <td>
                        .
                        </td>
                        <td><?= $row->description ?><br><?= $row->size ?></td>
                        <td ><?= $row->qty_no ?></td>
                        <td><?= $row->qty_wt ?></td>
                        <td><?= $row->uom ?></td>
