...
<body>
    <center><h3>Loan Approval</h3></center>
        <form  action="<?= base_url('index.php/users/loan_approval_succees')?>" onsubmit="return confirm('Do You Want To Approve???');" method="post">
            <div class="container">
                <div id="accordion">
                    <h3 style="background:#428bca;color:white;" class="emp_detail">Employee Detail <span style="float:right;color: #495C70;"><b><?php   echo date("d-m-y"); ?></b></span></h3>
                        <div>
                        <div class="form-style-4">
                            <label for="name">
                                <span align="left">Name</span><input type="text" id="name" name="name" class="name" required="true" value="<?= $approval_detail->l_emp_name ?>" readonly/><input type="hidden" name="job_cat" id="job_cat" class="job_cat" value="<?= $approval_detail->l_job_category;?>"/>
                            </label>
                            ...
                            <label for="field1">
                                <span align="left">Purpose</span><input type="text" name="reas" value="<?= $approval_detail->l_purpose?>" readonly/>
                            </label>
                            ...
                            <label for="field2">
                                <span align="left">Amount required</span><input type="text"  name="field2" value="<?= $approval_detail->l_amt_reqd?>" readonly />
                            </label>

                            <label>
                                <span align="left">Amount Sanctioned</span><input type="text" name="amt_sanct" class="amt_sanct" id="amt_sanct" tabindex="1" style="background-color:#20374f"/>
                            </label>
                            <div id="errmsg" style="background-color: red;width:100px;"></div>
                            ...
                            <label for="field2">
                                <span align="left">Mobile No.</span><input type="text"  name="field2" value="<?= $approval_detail->l_mobile ?>" readonly />
                            </label>
                         </div>    
                    </div>
                    <h3 style="background:#428bca;color:white;" class="app_detail">Approval Detail</h3>
                    <div>
                    <div class="form-style-4">
                    <label for="field2">
                    ...
                    <div class="approve">
                        ...
                        <label for="field1">
                            <span align="left">Paid to Mr./Mrs.</span><input type="text" id="emp_name" name="field1" required="true" value="<?= $approval_detail->l_emp_name ?>" readonly/>
                        </label>
                        <label for="field1">
                            <span align="left">Signature & Date</span><img id="image" src="<?php echo base_url();?>assets/images/rs.png" alt="logo" width='200' height='100' /><input type="text" name="date" id="date" value="<?php echo date("d/m/y");?>" readonly/><input type="hidden" name="activity" class="activity" value="sanction"/>
                        </label>
                        
                        <input type="hidden" name="approve" class="req_approve" value="approve"/>
                        
                        <label>
                            <span>&nbsp;</span><input type="submit" value="Approve" class="submit_approve"/><input type="hidden" value="<?= $approval_detail->loan_id ?>" name="id" class="loan_id"/><input type="hidden" name="empid" class="empid" value="<?= $approval_detail->id?>"/>
                        </label>
                    </div> 
 ...
 <div class="fixed-action-btn vertical" style="bottom: 45px; right: 24px;">
                ...
                <ul>
                    <li><a class="btn-floating yellow darken-1" data-placement="bottom" title="View Loan List"  href="<?php echo base_url();?>index.php/users/show_loan"><i class="glyphicon glyphicon-search"></i></a></li>
                    <li><a class="btn-floating green"  data-placement="bottom" title="Create New Loan Payment!"  href="<?php echo base_url();?>index.php/users/new_loan"><i class="glyphicon glyphicon-pencil"></i></a></li>
